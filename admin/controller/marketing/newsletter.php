...
class ControllerMarketingNewsletter extends \Core\Controller {
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_marketing_newsletter->addSubscriber($this->request->post);
            ...
            $this->redirect($this->url->link('marketing/newsletter', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_marketing_newsletter->editSubscriber($this->request->get['newsletter_id'], $this->request->post);
    ...
    protected function getList() {
        ...
        $data['insert'] = $this->url->link('marketing/newsletter/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        $subscribers_total = $this->model_marketing_newsletter->getTotalSubscribers();

        $results = $this->model_marketing_newsletter->getSubscribers($filter_data);


        foreach ($results as $result) {
            $data['subscribers'][] = array(
                'subscriber_id' => $result['customer_group_id'],
        ...
        $this->data = $data;
        $this->template = 'sale/customer_group_list.phtml';
    ...
    protected function getForm() {
        ...
        if (isset($this->request->post['name'])) {
            $data['name'] = $this->request->post['description'];
        ...
        $this->template = 'sale/customer_group_form.phtml';
    ...
    public function autocomplete() {
        ...
        if (isset($this->request->get['filter_group'])) {
            ...
            $filter_data = array(
                'filter_name' => $this->request->get['filter_group'],
                'start' => 0,
                'limit' => 5
            );
