 ...
 * @name Settings - Country Managment
...
class ControllerLocalisationCountry extends \Core\Controller {
    ...
    protected function getList() {
        ...
        $this->data = $data;
        $this->template = 'localisation/country_list.phtml';
    ...
    protected function getForm() {
        ...
        $this->data = $data;
        $this->template = 'localisation/country_form.phtml';
