 ...
 * @name Settings - Language File Editor
...
class ControllerLocalisationLanguage extends \Core\Controller {
    ...
    public function index() {
        ...
        $edit_lang = $this->data['name_language'] = $this->config->get('config_language');
        ...
        $this->data['action_select'] = $this->url->link('localisation/language', 'token=' . $this->session->data['token'] . $file_param_pass);
        $this->data['file_link'] = $this->url->link('localisation/language', 'token=' . $this->session->data['token'] . $link_param_section . "&name_language=" . $edit_lang . "&file=");
        $this->data['action_edit'] = $this->url->link('localisation/language', 'token=' . $this->session->data['token'] . $link_param_section . "&name_language=" . $edit_lang . "&file=" . $edit_file . "&string=");
        $this->data['viewing_file_link'] = $this->url->link('localisation/language', 'token=' . $this->session->data['token'] . $link_param_section . "&name_language=" . $edit_lang . "&file=" . $edit_file);
        ...
        $this->data['breadcrumbs'][] = array(
            'href' => $this->url->link('localisation/language', 'token=' . $this->session->data['token']),
            'text' => $this->language->get('heading_title'),
            'separator' => '  ::  '
        );


        if (isset($this->data['showmsg'])) {
            if ($this->data['showmsg'] == 'error') {
                $this->data['error_warning'] = $this->data['msg_error'];
            }
            if ($this->data['showmsg'] == 'success') {
                $this->data['success'] = $this->data['msg_success'];
            }
        }
        ...
        if (isset($this->request->get['file']) && substr($this->request->get['file'], 0, 1) != ".") {
            ...
            $selectedfile = ucfirst($this->data['name_language']) . ' :: ' . ucfirst($this->data['name_language']) . ' <span>(' . $this->data['name_language'] . '.php)</span>';
        };
        ...
        $this->template = 'localisation/language.phtml';
        $this->children = array(
            'common/header',
            'common/footer'
        );
