...
class ControllerLocalisationOrderStatus extends \Core\Controller {
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->redirect($this->url->link('localisation/order_status', 'token=' . $this->session->data['token'] . $url, true));
        }
    ...
    protected function getForm() {
        ...
        if (isset($this->request->post['name'])) {
            $data['order_status'] = $this->request->post['name'];
        } elseif (isset($this->request->get['order_status_id'])) {
            $data['order_status'] = $this->model_localisation_order_status->getOrderStatus($this->request->get['order_status_id'])['name'];
        } else {
            $data['order_status'] = '';
        }
