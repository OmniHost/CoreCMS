...
class ControllerLocalisationZone extends \Core\Controller {
    ...
    protected function getForm() {
        ...
        $this->response->setOutput($this->render('localisation/zone_form.phtml', $data));
    }
