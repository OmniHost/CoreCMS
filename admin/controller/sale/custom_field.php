 ...
 * @name System - Custom fields Management
...
class ControllerSaleCustomField extends \Core\Controller {
    ...
    protected function getForm() {
       ...
       /* $this->load->model('localisation/language');
        ...
        if (isset($this->request->post['name'])) {
            ...
            $data['name'] = $custom_field_info['name'];
        } else {
            $data['name'] = '';
        }
        ...
        foreach ($custom_field_values as $custom_field_value) {
            $data['custom_field_values'][] = array(
                ...
                'custom_field_value_description' => $custom_field_value['name'],
        ...
        $this->response->setOutput($this->render('sale/custom_field_form.phtml', $data));
    }
