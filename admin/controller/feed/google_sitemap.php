 ...
 * @package     CoreCMS
 */
class ControllerFeedGoogleSitemap extends \Core\Controller {
	private $error = array();
	...
	public function index() {
		...
		$data['data_feed'] = HTTP_CATALOG . 'index.php?p=feed/google_sitemap';
                
                 $this->data = $data;
        $this->template = 'feed/google_sitemap.phtml';
        $this->children = array(
            'common/header',
            'common/footer'
        );
