...
class ControllerUserReset extends \Core\Controller {
    ...
    public function index() {
        ...
        if ($user_info) {
            ...
            $this->data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('user/reset', '', 'SSL'),
            ...
            $this->data['action'] = $this->url->link('user/reset', 'code=' . $code, 'SSL');
            ...
            $this->template = 'user/reset.phtml';
