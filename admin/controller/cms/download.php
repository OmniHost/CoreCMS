...
class ControllerCmsDownload extends \Core\Controller {
    ...
    public function index() {
        $this->load->language('cms/download');
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_cms_download->addDownload($this->request->post);
            ...
            $this->redirect($this->url->link('cms/download', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_cms_download->editDownload($this->request->get['download_id'], $this->request->post);
    ...
    public function delete() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            foreach ($this->request->post['selected'] as $download_id) {
                $this->model_cms_download->deleteDownload($download_id);
            }
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('cms/download', 'token=' . $this->session->data['token'] . $url, 'SSL')
        );
    ...
    protected function getForm() {
        ...
        if (!isset($this->request->get['download_id'])) {
            $data['action'] = $this->url->link('cms/download/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
        } else {
        ...
        if (isset($this->request->get['download_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $download_info = $this->model_cms_download->getDownload($this->request->get['download_id']);
        }
        ...
        $this->template = 'cms/download_form.phtml';
        $this->data = $data;
        $this->children = array(
            'common/header',
            'common/footer'
    ...
    protected function validateForm() {
        if (!$this->user->hasPermission('modify', 'cms/download')) {
