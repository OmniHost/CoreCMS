...
confCkeditor.customConfig = 'dentifrice_config.js';
        ...
        $(config.selector).find('.dtf-contentEditable')
          .attr('contentEditable',true)
          .ckeditor({customConfig: 'dentifrice_config.js'});
      }
    ...
    var _fetchBlocksConfig = function () {
        ...
        */
        ...
        _.forOwn(blocks_config.styles, function (config, name) {
			...
			data.ckEditor.customConfig = 'dentifrice_config.js';
                ...
                $(config.selector).find('.dtf-contentEditable')
                .attr('contentEditable', true)
                .ckeditor({language: settings.lang, customConfig: 'dentifrice_config.js'});
