    ...
    <fieldset>
      <table>
        ...
        <tr>
          ...
          <td><?php echo is_writable($modification) ? '<span class="good">Writable</span>' : '<span class="bad">Unwritable</span>'; ?></td>
        </tr>
        <tr>
          <td><?php echo $upload . '/'; ?></td>
          <td><?php echo is_writable($upload) ? '<span class="good">Writable</span>' : '<span class="bad">Unwritable</span>'; ?></td>
        </tr>
      </table>
    </fieldset>
    <div class="buttons">
