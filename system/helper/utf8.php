 ...
 */
/**
 * collection of utf8 utitlities
 */

/**
 * returns length of string utf8 decoded
 * @param string $string
 * @return int
 * @see strlen
 * @see utf8_decode
...
/**
 * strtolower utf8 save
 * @staticvar null $UTF8_UPPER_TO_LOWER
 * @param string $string
 * @return boolean
 */
...
/**
 * @see strtoupper
 * @staticvar null $UTF8_LOWER_TO_UPPER
 * @param string $string
 * @return string
 */
