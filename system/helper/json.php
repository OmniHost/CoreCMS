 ...
 */
/**
 * @todo - Perhaps we should depricate this as any 5.3 + server generally has json now specially for the js intergrations.!?
 */
if (!function_exists('json_encode')) {

    /**
     * Emulate native php json_encode
     * @param mixed $data
     * @return string
     * @see json_encode
     */
