...
class Newsletter {
    ...
    /*     * * BELOW HERE WE NOT TO SURE OF JUST YET ** */

    /**
     * CHECK IF WE GONNA USE -- PERHAPS USE THE BUILDER ONLY!?
     * @return type
     * @TODO
     */
    ...
    /**
     * @todo test if we need it
     * @todo meld into our sending sub-system!
     * @param type $email_to
     * @param type $email_subject
     * @param type $email_contents
     * @param type $email_from
     * @param type $email_from_name
     * @param type $options
     * @return boolean
     */
    ...
    /**
     * @todo test if we need it - and merge into our model rather
     * @param type $db
     * @param type $newsletter_id
     * @param type $fields
     * @return type
     ...
     * @param type $db
     * @param type $newsletter_id
     * @param type $newsletter_content_id
     */
