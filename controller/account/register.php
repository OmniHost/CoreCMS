...
class ControllerAccountRegister extends \Core\Controller {
    ...
    public function index() {
        ...
        if(!$this->config->get('config_account_register')){
        ...
        if ($this->config->get('config_account_id')) {
            ...
            $cms_info = $this->model_cms_page->loadPageObject($this->config->get('config_account_id'));

            if ($cms_info->id) {
                $data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->link('cms/page/agree', 'page_id=' . $this->config->get('config_account_id'), 'SSL'), $cms_info->name, $cms_info->name);
            } else {
                $data['text_agree'] = '';
            }
        } else {
        ...
        $this->template = 'account/register.phtml';
        $this->data = $data;
    ...
    public function validate() {
        ...
        if ($this->config->get('config_account_id')) {
            ...
            $information_info = $this->model_cms_page->loadPageObject($this->config->get('config_account_id'));

            if ($information_info && !isset($this->request->post['agree'])) {
                $this->error['warning'] = sprintf($this->language->get('error_agree'), $information_info->name);
            }
        }
