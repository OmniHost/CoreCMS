...
class ControllerCommonColumnBottom extends \Core\Controller {
    ...
    public function index() {
        ...
        $modules = $this->model_design_layout->getLayoutModules($layout_id, 'column_bottom');
        ...
        $this->template = 'common/column_bottom.phtml';
         $this->render();
    }
